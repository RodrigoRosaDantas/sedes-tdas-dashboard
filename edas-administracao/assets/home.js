import{loadData,setupShell,fmtNumber,fmtPct,fmtDate,metric,alertCard,routes,countdown,setLoadingError,escapeHTML}from'./common.js?v=20260807.1';
try{
 ...
 <footer class="footer"><span>EDAS · Plataforma v${escapeHTML(d.meta.version||'20260807.1')}</span><span>Sincronização: <span data-sync></span></span></footer>`;
