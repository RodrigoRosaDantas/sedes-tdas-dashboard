import{loadData,setupShell,fmtNumber,fmtPct,fmtDate,metric,alertCard,routes,countdown,setLoadingError,escapeHTML}from'./common.js?v=20260805.2';
try{
 ...
 <footer class="footer"><span>EDAS · Plataforma v${escapeHTML(d.meta.version||'20260805.2')}</span><span>Sincronização: <span data-sync></span></span></footer>`;
