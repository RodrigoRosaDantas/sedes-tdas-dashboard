...
const CORE=[
 ...
 BASE+'offline.html',BASE+'manifest.webmanifest',BASE+'data/site.json',BASE+'data/integration/question-catalog.json',
 BASE+'assets/common.js',BASE+'assets/home.js',BASE+'assets/today.js',BASE+'assets/evolution.js',BASE+'assets/risks.js',BASE+'assets/agenda.js',BASE+'assets/cases.js',BASE+'assets/audit.js',BASE+'assets/more.js',BASE+'assets/edas.css',
