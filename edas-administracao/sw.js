...
const CORE=[
 ...
 BASE+'offline.html',BASE+'manifest.webmanifest',BASE+'data/site.json',BASE+'data/sync-history.json',BASE+'data/integration/question-catalog.json',BASE+'data/integration/answer-key.json',BASE+'data/integration/daily-material.json',BASE+'data/integration/daily-contract.json',BASE+'data/integration/navigation.json',
