...
assert.match(version.serviceWorkerVersion,/pro13$/,'Manifesto deve usar cache PRO13 responsivo.');
assert.match(sw,/pro13/,'Service worker deve usar cache PRO13 responsivo.');
assert.ok(!sw.includes('question-keys/'),'Gabarito continua fora do precache inicial.');
console.log('Command Palette TDAS validada: ações, PE01–PE112, matérias, prioridades externas, teclado, foco, PWA PRO13 e blindagem do gabarito.');
