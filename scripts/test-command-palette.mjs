...
assert.match(version.serviceWorkerVersion,/pro11$/,'Manifesto deve usar cache PRO11 otimizado.');
assert.match(sw,/pro11/,'Service worker deve usar cache PRO11 otimizado.');
assert.ok(!sw.includes('question-keys/'),'Gabarito continua fora do precache inicial.');
console.log('Command Palette TDAS validada: ações, PE01–PE112, matérias, prioridades externas, teclado, foco, PWA PRO11 e blindagem do gabarito.');
