...
assert.match(version.serviceWorkerVersion,/pro12$/,'Manifesto deve usar cache PRO12 otimizado.');
assert.match(sw,/pro12/,'Service worker deve usar cache PRO12 otimizado.');
assert.ok(!sw.includes('question-keys/'),'Gabarito continua fora do precache inicial.');
console.log('Command Palette TDAS validada: ações, PE01–PE112, matérias, prioridades externas, teclado, foco, PWA PRO12 e blindagem do gabarito.');
