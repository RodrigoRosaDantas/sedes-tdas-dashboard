...
required(player.includes('Somente a tentativa concluída é salva'), 'A interface não explica o escopo da persistência.');
required(player.includes('Este resultado não foi enviado ao Notion nem ao progresso oficial'), 'A interface não informa o isolamento externo.');
...
console.log('Histórico local validado: namespace oficial, tentativa concluída, deduplicação, limite, corrupção protegida e zero writeback.');
