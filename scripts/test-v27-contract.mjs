...
assert.ok(preserveHistory.includes('nenhum asset de histórico pessoal/Firebase')&&!preserveHistory.includes('question-archive/index.json'),'Guard PWA deve impedir a reintrodução de histórico pessoal sem republicar catálogos como histórico do usuário.');
...
console.log('TDAS v27: contrato estrutural, prioridades externas e preservação operacional validados.');
