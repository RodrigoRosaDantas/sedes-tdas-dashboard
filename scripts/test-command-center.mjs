...
assert.ok(index.includes('home-command-center.js?v=1.3.0'));
...
console.log(`Fases 1–3 validadas: central, retomada, fechamento oficial, revisão adaptativa, publicação ${platform.publicationId} e ${missing.length} origens pendentes sem inferência ou writeback.`);
