...
const requiredAssets=['assets/integration/daily-execution.js','assets/integration/today-execution.js','assets/integration/daily-question-page.js','assets/integration/daily-progress.js','assets/integration/module-dashboard.js','assets/integration/module-player.js','assets/integration/module-store.js','assets/integration/module-reviews.js','assets/integration/module-error-book.js','assets/integration/module-performance.js','assets/integration/module-ai-queue.js','assets/integration/player-core.js','assets/integration/player.css'];
...
required(/^tdas-v26-daily-\d{8}-execution$/.test(version),`versão inválida: ${version}`);
...
console.log(`PWA validado: ${requiredRoutes.length} rotas, ${requiredAssets.length} módulos e acompanhamento local offline.`);
