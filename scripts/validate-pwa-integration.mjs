...
const requiredAssets=['assets/integration/daily-execution.js','assets/integration/today-execution.js','assets/integration/daily-question-page.js','assets/integration/module-dashboard.js','assets/integration/module-player.js','assets/integration/module-store.js','assets/integration/module-reviews.js','assets/integration/module-error-book.js','assets/integration/module-performance.js','assets/integration/module-ai-queue.js','assets/integration/player-core.js','assets/integration/player.css'];
...
console.log(`PWA validado: ${requiredRoutes.length} rotas, ${requiredAssets.length} módulos e contrato PE01–PE112 offline.`);
