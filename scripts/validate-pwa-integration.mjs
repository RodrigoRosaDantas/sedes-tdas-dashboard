...
const requiredAssets=['assets/integration/daily-execution.js','assets/integration/daily-law.js','assets/integration/today-execution.js','assets/integration/daily-question-page.js','assets/integration/daily-progress.js','assets/integration/local-backup.js','assets/integration/daily-content.css','assets/integration/command-center.css','assets/integration/home-command-center.js','assets/integration/audit-unlinked-errors.js','assets/integration/session-draft.js','assets/integration/module-dashboard.js','assets/integration/module-player.js','assets/integration/module-store.js','assets/integration/module-reviews.js','assets/integration/module-error-book.js','assets/integration/module-performance.js','assets/integration/module-ai-queue.js','assets/integration/player-core.js','assets/integration/player.css'];
...
required(postprocess.includes('-notion-daily-content-phase1-100'),'Gerador do PWA não preserva a versão da Fase 1.');
...
console.log(`PWA validado: ${requiredRoutes.length} rotas críticas, ${requiredAssets.length} módulos, central e retomada offline, correção fora do precache.`);
