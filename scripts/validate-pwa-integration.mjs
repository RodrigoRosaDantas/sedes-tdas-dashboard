...
const requiredAssets=['assets/integration/daily-execution.js','assets/integration/daily-law.js','assets/integration/today-execution.js','assets/integration/daily-question-page.js','assets/integration/daily-progress.js','assets/integration/local-backup.js','assets/integration/module-dashboard.js','assets/integration/module-player.js','assets/integration/module-store.js','assets/integration/module-reviews.js','assets/integration/module-error-book.js','assets/integration/module-performance.js','assets/integration/module-ai-queue.js','assets/integration/player-core.js','assets/integration/player.css'];
...
required(/^tdas-v26-daily-\d{8}-law-library$/.test(version),`versão inválida: ${version}`);
...
required(postprocess.includes("-law-library'"),'Gerador do PWA não preserva a versão da Lei Seca.');
...
console.log(`PWA validado: ${requiredRoutes.length} rotas críticas, ${requiredAssets.length} módulos, Lei Seca, backup e gerador offline consistentes.`);
