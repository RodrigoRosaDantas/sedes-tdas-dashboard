...
assert.equal(reviews.primary.kind,'review');assert.equal(reviews.dueReviews,1);assert.equal(reviews.queue[1].kind,'plan');assert.equal(reviews.queue[2].kind,'errors');
