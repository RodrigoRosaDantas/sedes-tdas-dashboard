...
required(syncPage.includes('Sincronização em nuvem aposentada')&&!/private-history-page|firebase/i.test(syncPage),'rota de sincronização não pode carregar autenticação/nuvem');
...
required(pwaGuard.includes('nenhum asset de histórico pessoal/Firebase'),'pipeline precisa impedir reintrodução no PWA');
