...
const sw=`const VERSION='tdas-v26-${new Date().toISOString().slice(0,10).replaceAll('-','')}-official';
...
console.log(JSON.stringify({version:VERSION,errorParts:partCount,subjects:slugs.length,totalPE}));
