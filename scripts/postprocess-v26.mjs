...
const sw=`const VERSION='tdas-v26-real-${new Date().toISOString().slice(0,10).replaceAll('-','')}-official';
...
console.log(JSON.stringify({version:VERSION,mode:'real-operations',errorParts:partCount,subjects:slugs.length,totalPE}));
