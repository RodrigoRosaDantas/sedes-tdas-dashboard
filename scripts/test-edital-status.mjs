...
console.log(`Checklist vivo validado: ${status.summary.total} tópicos, ${status.summary.risk.critical} críticos, ${status.summary.risk.attention} em atenção, ${status.summary.risk.no_evidence} sem aferição granular, ${status.summary.contentGaps} lacunas.`);
