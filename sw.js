...
const PRECACHE=[
 BASE,BASE+'hoje/',BASE+'evolucao/',BASE+'riscos/',BASE+'agenda/',BASE+'redacoes/',BASE+'auditoria/',BASE+'mais/',BASE+'questoes-erros/',BASE+'pe/',BASE+'pe/74/',BASE+'materias/',BASE+'offline.html',BASE+'manifest.webmanifest',
 ...
 BASE+'data/home.json',BASE+'data/today.json',BASE+'data/evolution.json',BASE+'data/risks.json',BASE+'data/agenda.json',BASE+'data/redactions.json',BASE+'data/audit.json',BASE+'data/more.json',BASE+'data/subjects.json',BASE+'data/sync-history.json',BASE+'data/live-v24.json',BASE+'data/error-questions/index.json',
