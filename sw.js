const VERSION='tdas-v23-20260729a';
const BASE='/sedes-tdas-dashboard/';
const PRECACHE=[
 BASE,BASE+'hoje/',BASE+'evolucao/',BASE+'riscos/',BASE+'agenda/',BASE+'redacoes/',BASE+'auditoria/',BASE+'mais/',BASE+'questoes-erros/',BASE+'pe/',BASE+'pe/73/',BASE+'materias/',BASE+'offline.html',BASE+'manifest.webmanifest',
