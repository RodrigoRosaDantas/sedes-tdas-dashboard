...
export function setupShell(page,meta){
 ...
 if('serviceWorker'in navigator)navigator.serviceWorker.register(BASE+'sw.js?v=20.4').catch(console.error);
 setupInstall();loadV20Enhancements();
}
function loadV20Enhancements(){if(!document.querySelector('link[data-v20]')){const l=document.createElement('link');l.rel='stylesheet';l.href=BASE+'assets/v20.css?v=20.3';l.dataset.v20='1';document.head.appendChild(l)}import(BASE+'assets/enhance-v20.js?v=20.3').catch(console.error)}
