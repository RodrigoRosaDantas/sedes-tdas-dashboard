...
const LIVE_VERSION='20260729-2337-v23';
let livePromise=null;
async function loadLive(){
 if(!livePromise)livePromise=fetch(BASE+'data/live-v23.json?v='+LIVE_VERSION,{cache:'no-store'})
...
export async function loadJSON(path){
 ...
 const data=await r.json();if(path==='data/live-v23.json')return data;
