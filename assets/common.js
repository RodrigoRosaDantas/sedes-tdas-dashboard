...
const LIVE_VERSION='20260730-v24-1';
...
export function setupShell(page,meta){
 ...
 document.querySelector('.brand small')?.replaceChildren(`SEDES/DF · v${meta.version||'24.1'}`);
 ...
 if('serviceWorker'in navigator)navigator.serviceWorker.register(BASE+'sw.js?v=24.1').catch(console.error);
 setupInstall();loadV20Enhancements();
}
function loadV20Enhancements(){if(!document.querySelector('link[data-v20]')){const l=document.createElement('link');l.rel='stylesheet';l.href=BASE+'assets/v20.css?v=24.1';l.dataset.v20='1';document.head.appendChild(l)}import(BASE+'assets/enhance-v20.js?v=24.1').catch(console.error)}
