...
try{
 ...
 const action=selectPrimaryAction({pe,progress:effective,draft,attempt,nextPe,dueReview,officialCompleted,officialTasks,base:BASE});
 const pendingOfficial=officialTasks.filter(item=>item.id!=='next'&&!item.done);
