...
if(reviewId){document.documentElement.dataset.questionMode='review';const{installReviewCatalogBridge}=await import('./review-catalog-bridge.js?v=1.1.0');await installReviewCatalogBridge(reviewId);await import('./module-player.js?v=2.1.0');await import('./question-telemetry-runtime.js?v=1.0.0')}
