...
async function init(){renderShell();renderTrigger();bind();items=[...peItems];render('');const remotes=await remoteItems();remotes.forEach(item=>item._remote=true);items=[...peItems,...remotes];render('')}
