...
try{
 ...
 <section class="hero">
  ...
  <div class="hero-actions"><a class="btn primary" href="${routes.hoje}">Abrir foco de hoje</a><a class="btn" href="${STUDY_BASE}estudar/">Central de estudo</a><a class="btn" href="${routes.evolucao}">Ver evolução</a></div>
